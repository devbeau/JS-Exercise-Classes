...
class Instructor extends Lambdasian{
  ...
  gradeAssignments(student){
    ...
    if (upOrDown = 0) {return student.grade -= Math.floor(Math.random()*21);}
    else {return student.grade += Math.floor(Math.random()*21);}
}
}
...
class Student extends Lambdasian{
  ...
  listSubjects(){return `Loving ${this.favSubjects[0]}, ${this.favSubjects[1]}, ${this.favSubjects[2]}`}
